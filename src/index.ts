...
let item2 = new Item("title1", "url1", "description1", "http://sc.chinaz.com/Files/pic/indexpic/newtj1.jpg")
let item3 = new Item("title1", "url1", "description1", "http://sc.chinaz.com/Files/pic/indexpic/newtj1.jpg")
let item4 = new Item("title1", "url1", "description1", "http://sc.chinaz.com/Files/pic/indexpic/newtj1.jpg")
